...
import static ru.javawebinar.graduation.RestaurantDataTest.*;
import static ru.javawebinar.graduation.model.AbstractBaseEntity.START_SEQ;

public class DishDataTest {
    ...
    static final Dish DISHNEW = new Dish(START_SEQ + 15, "New", of(2019, Month.NOVEMBER, 23), 111);
